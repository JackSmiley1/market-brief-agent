...
\`\`\`watchlist-followup
{
  ...
  "newWatchlist": [{"ticker": "NVDA", "setup": "one-sentence restatement of the condition to watch for", "direction": "long", "confidence": "medium"}]
}
\`\`\`
